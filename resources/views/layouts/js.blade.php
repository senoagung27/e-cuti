...
<script src="{{ url('node_modules/cleave.js/dist/cleave.min.js') }}"></script>
<script src="{{ url('node_modules/cleave.js/dist/addons/cleave-phone.us.js') }}"></script>
...
<script src="{{ url('node_modules/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js') }}"></script>
<script src="{{ url('node_modules/bootstrap-timepicker/js/bootstrap-timepicker.min.js') }}"></script>
...
<script src="{{ url('node_modules/prismjs/prism.js') }}"></script>
